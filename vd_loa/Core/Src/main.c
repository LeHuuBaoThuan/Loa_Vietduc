...
//uint8_t status=0; // read button mode PB11
...
void MODE_1()
{
	...
	value_MIC = HAL_ADC_GetValue(&hadc1);
	HAL_ADC_Stop(&hadc1);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : IN_MODE_Pin */
  GPIO_InitStruct.Pin = IN_MODE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(IN_MODE_GPIO_Port, &GPIO_InitStruct);
